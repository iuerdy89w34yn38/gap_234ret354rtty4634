...
@section('content')
    ...
    <section id="package">
        <div class="container">
            ...
            <div class="row">
                @foreach($fixDepPackages as $data)
                    <div class="col-lg-4">
                        <div class="priceBox normal">
                            ...
                            <div class="list">
                                <ul>
                                    ...
                                    <li>
                                        <p>
                                            @lang('Profit') : <strong> {{$data->percent_return}}%</strong>
                                        </p>
                                    </li>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('user.fix.dep.store')}}" method="POST">
                        @csrf
                        <input type="hidden" name="id" id="gateWay"/>
                        <div class="form-group">
                            <h4> <label>@lang('Enter Your Fixed Deposit Amount')</label></h4>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn viweBtn" style="width:100%;">@lang('Dps Now')</button>
                        </div>
                    </form>
                </div>
