...
<html>
  ...
  <body>
     ...
     .login-content {
              ...
              background: -webkit-linear-gradient(-30deg, #{{$gnl->color1}} 0%, #{{$gnl->colortwo}} 100%);
                background: -moz-linear-gradient(-30deg, #{{$gnl->color1}} 0%, #{{$gnl->colortwo}} 100%);
                background: linear-gradient(-30deg, #{{$gnl->color1}} 0%, #{{$gnl->colortwo}} 100%);
          }
      </style>
