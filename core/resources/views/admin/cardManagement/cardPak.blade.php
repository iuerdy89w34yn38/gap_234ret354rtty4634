...
@section('title', 'All Card Package')

@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1> All Card Package </h1>
            </div>
             <button   class="btn btn-info" data-toggle="modal" data-target="#addCard"><i class="fa fa-plus"></i> Add new</button>
                ...
                <table class="table table-hover">
                    ...
                    @foreach($paks as $data)
                        <tr>
                            ...
                            <td class="text-center"> {{$data->fixed_charge}} BTC</td>
    ...
    {{--/// added modal - start/////--}}
    <div class="modal fade bd-example-modal-lg" id="addCard" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="row" method="post"  action="{{route('admin.card.pak.add')}}">
                        @csrf
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control form-control-lg" name="days" required="">
                        ...
                        <div class="form-group col-md-6 hidden">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input class="form-control form-control-lg" type="number" name="min_amount"  value="0" >
                        ...
                        <div class="form-group col-md-6 hidden">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">{{$gnl->cur_symbol}}</span></div>
                                    <input class="form-control form-control-lg" type="number"  name="max_amount" value="10000" >
                                    <div class="input-group-append"><span class="input-group-text">{{$gnl->cur}}</span></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input class="form-control form-control-lg" type=""  name="fixed_charge" required>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                                ...
                                <form class="row" method="post"  action="{{route('admin.card.pak.update')}}">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="control-label ">Type</label>
                                        <select class="form-control form-control-lg" name="days" required="" id="days">
                                <option value="1">VISA</option>
                                <option value="2">MASTERCARD</option>
                            </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text">₿</span></div>
                                                <input class="form-control form-control-lg" type=""  name="fixed_charge" id="fixed_charge" required>
                                                <div class="input-group-append"><span class="input-group-text">BTC</span></div>
                                            </div>
                                        </div>
                                    </div>
