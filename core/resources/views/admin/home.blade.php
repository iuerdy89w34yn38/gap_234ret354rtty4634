                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div>
                                        <div class="form-group">
                                            <h5> <label  class="col-form-label">Title</label></h5>
                                            <div class="input-group">
                                                <input type="text" name="investor_title" value="{{$gnl->investor_title}}"  class="form-control form-control-lg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-8">
                                    <div>
                                        <div class="form-group">
                                            <h5> <label  class="col-form-label">Subtitle</label></h5>
                                            <div class="input-group">
                                                <input type="text" name="investor_des" value="{{$gnl->investor_des}}"  class="form-control form-control-lg">
                                ...
                                <div class="col-md-6 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <h2>Latest Transaction Section</h2>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div>
                                        <div class="form-group">
                                            <h5> <label  class="col-form-label">Title</label></h5>
                                            <div class="input-group">
                                                <input type="text" name="latest_tran_title" value="{{$gnl->latest_tran_title}}"  class="form-control form-control-lg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-8">
                                    <div>
                                        <div class="form-group">
                                            <h5> <label  class="col-form-label">Subtitle</label></h5>
                                            <div class="input-group">
                                                <input type="text" name="latest_tran_des" value="{{$gnl->latest_tran_des}}"  class="form-control form-control-lg">
