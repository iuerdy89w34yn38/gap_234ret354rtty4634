...
<!---->
        ...
        <li class="treeview @if(request()->route()->getName() == 'admin.card.pak') is-expanded
            ...
            @elseif(request()->route()->getName() == 'admin.card.request') is-expanded
               @endif">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">Card Management</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.card.pak') active @endif" href="{{route('admin.card.pak')}}"><i class="icon fa fa-desktop"></i>Package</a></li>
                <li><a class="treeview-item @if(request()->route()->getName() == 'admin.card.request') active @endif" href="{{route('admin.card.request')}}"><i class="icon fa fa-desktop"></i>Card request</a></li>
