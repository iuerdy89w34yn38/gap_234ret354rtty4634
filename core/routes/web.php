...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin', 'as' => 'admin.'], function () {
    ...
    /////card////
    Route::get('card/packages', 'CardController@cardPackage')->name('card.pak');
    Route::get('card/request', 'CardController@cardRequest')->name('card.request');
    Route::post('card/packages/add', 'CardController@cardPackageAdd')->name('card.pak.add');
    Route::post('card/packages/update', 'CardController@cardPackageUpdate')->name('card.pak.update');

    Route::post('card/request/update', 'CardController@cardRequestUpdate')->name('card.request.update');
...
Route::group(['prefix' => 'user', 'middleware' => 'auth', 'as' => 'user.'], function () {
    ...
    Route::group(['middleware' => 'active_status'], function () {
        ...
        Route::group(['middleware' => 'verify_user'], function () {
            ...
            Route::get('/card-history', 'UserController@cardHistory')->name('card.history');
            Route::post('/card/repay', 'UserController@cardRepay')->name('card.repay');
            ...
            Route::group(['middleware' => 'card_payable_user'], function () {
                ...
                Route::get('/card-package', 'UserController@cardPackage')->name('card.package');

                Route::post('/card/store', 'UserController@cardStore')->name('card.store');
